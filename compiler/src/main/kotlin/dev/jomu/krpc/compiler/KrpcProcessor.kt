                ...
                addFunction(
                    FunSpec.builder(endpoint.endpoint.name).apply {
                        ...
                        addCode(buildCodeBlock {
                            ...
                            addStatement("val message = %T(request.metadata.%M(), request.value, %N.serializer(), json)", EncodableMessage::class, MemberName("dev.jomu.krpc.runtime", "toHttpHeaders"), endpoint.request)
                            ...
                            addStatement("%T(response.error!!.code, response.error.message, response.error.details, metadata)", Error::class)
                            endControlFlow()
                            endControlFlow()
